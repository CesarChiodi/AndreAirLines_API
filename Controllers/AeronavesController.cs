...
namespace AndreAirLines_API.Controllers
{
    ...
    public class AeronavesController : ControllerBase
    {
        ...
        public AeronavesController(AndreAirLines_APIContext context)
        {
            _context = context;
        }
        ...
        {
            //var placa = await _context.Aeronave.Where(aeronave => aeronave.IdAeronave == aeronave.IdAeronave).FirstOrDefaultAsync();
            //aeronave = placa;
            ...
            return CreatedAtAction("GetAeronave", new { id = aeronave.IdAeronave }, aeronave);
        }
        ...
        {
            return _context.Aeronave.Any(e => e.IdAeronave == id);
        }
    }
}
